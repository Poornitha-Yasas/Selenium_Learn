...
public class JavascriptExecutorExample {
    ...
    public void jsExecutorTests() throws InterruptedException {
        ...
        //jsExecutor.executeScript("alert('Welcome to learn with Yasas...');");
        ...
        //jsExecutor.executeScript("arguments[0].value='Learn with Yasas';", inputNameTextBox);

            //2.2) - way 2 > Set the value using setAttribute (alternative approach)
        jsExecutor.executeScript("arguments[0].setAttribute('value', 'Yasas');", inputNameTextBox);
